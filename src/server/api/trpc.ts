...
export const isAuthedMiddleware = t.middleware(({ ctx, next }) => {
 ...
 if(ctx.session.user.role == 'user'){
  throw new Error ("User does not accept by admin")
 }
...
export const protectedProcedure = t.procedure
  ...
  export const adminProcedure = t.procedure.use(timingMiddleware).use(isAdminMiddleware)
  export const editoreProcedure = t.procedure.use(timingMiddleware).use(isEditorMiddleware)